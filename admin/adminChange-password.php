...
if(strlen($_SESSION['alogin'])==0)
	{	
		...
		{
			$sql=mysqli_query($con,"SELECT password FROM  admin where password='".$_POST['password']."' && username='".$_SESSION["admin_name"]."'");
			$num=mysqli_fetch_array($sql);
			
			if($num>0)
			{
				$con=mysqli_query($con,"update admin set password='".$_POST['newpassword']."' where username='".$_SESSION["admin_name"]."'");
